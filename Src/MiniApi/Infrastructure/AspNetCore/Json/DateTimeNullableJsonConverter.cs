...
namespace Juzhen.MiniProgramAPI.Infrastructure.AspNetCore
{
    public class DateTimeNullableJsonConverter : JsonConverter<DateTime?>
    {
        readonly string _dateFormatString;

        public DateTimeNullableJsonConverter()
        {
            _dateFormatString = "yyyy-MM-dd HH:mm:ss";
        }
        public DateTimeNullableJsonConverter(string dateFormatString)
        {
