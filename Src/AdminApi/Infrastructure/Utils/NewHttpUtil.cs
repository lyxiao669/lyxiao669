...
namespace Mammothcode.Library.Web
{
    /// <summary>
    /// 通用的请求工具
    /// </summary>
    public static class NewHttpUtil
    {
        /// <summary>
        /// 发起请求
        /// </summary>
        ...
        /// <returns></returns>
        public static HttpResult Post(HttpItem item,string token)
        {
            ...
            {
                SetHttpItem(item);
                request = CreateRequest(item,token);
        ...
        /// <param name="token"></param>
        /// <returns></returns>
        private static HttpWebRequest CreateRequest(HttpItem item,string token)
        {
            ...
            request.Headers.Add("terminal", "Weixin");
